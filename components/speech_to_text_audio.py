...
#         # This method will wait until the final transcription is received
#         final_transcript = None
#         while True:
#             transcript = await self.transcription_results.get()
#             if transcript is None:
#                 # This indicates the end of the transcription
#                 break
