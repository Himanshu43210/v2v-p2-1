...
#         if not playback_stream.is_active():
...
# # URL from which you want to extract the hostname
# url = "https://socket.itsolutionshub.com/"

# # Extracting the hostname from the URL
# parsed_url = urlparse(url)
# hostname = parsed_url.hostname

# # Use the extracted hostname for the socket connection
# HOST = hostname
# PORT = 65432
