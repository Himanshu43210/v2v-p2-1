...
async def receive_server_response(websocket):
    ...
    while True:
        try:
            async with websockets.connect(WEBSOCKET_URL) as websocket:
                ...
                # Start transcription (assuming this is a synchronous function)
                # transcription = transcriber.transcribe_stream()  # Adjust this call as per your Transcriber implementation
                ...
                await receive_server_response(websocket)
